...
fileLocation = "graph3-d/images/"
class Image:
    def __init__(self, x, y, xAngle, yAngle, zAngle, parentWindow):
        self.parentWindow = parentWindow
        self.x = x # Coordinates
        self.y = y
        self.xAngle = xAngle # Angle at which phothgraph should appear
        self.yAngle = yAngle
        self.zAngle = zAngle
        self.image = None
        self.move = False
    ...
    def window(self): # Imagewindow
        ...
        self.fileent = Entry(self.root, width = 20) # User input for file name of image
